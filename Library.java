...
public class Library {
    ...
    class Book implements Borrowable {
        ...
        public void showDetails() { //  open void showDetails()
            System.out.println("📕Title: " + title + ",✍️ Creator: " + writer
    ...
    public void displayAll() {
        if (shelf.isEmpty()) {
            System.out.println("No books accessible in the library.");
        } else {
            for (Book b : shelf) {
                b.showDetails();
            }
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    ...
                    lib.addBook(t, w, c);
                    System.out.println("✅Book included successfully!");
                    break;
                ...
                case 2:
                    ...
                    if (issueBook != null && issueBook.lendOut()) {
                        ...
                        System.out.println("❌Book not accessible or as of now issued.");
                    }
                    break;
                ...
                case 3:
                    ...
                    if (returnBook != null && returnBook.takeBack()) {
                        ...
                        System.out.println("❌Book not found or as of now in library.");
                    }
                    break;
                ...
                case 5:
                    exit = true;
                    System.out.println("Exiting Library Framework. Goodbye👋!");
                    break;

                default:
                    System.out.println("⚠️Invalid choice! Please Attempt again.");
            }
        }
